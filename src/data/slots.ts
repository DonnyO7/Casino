...
export const SLOTS: SlotConfig[] = [
  ...
  },
  {
    slug: 'dragons-hoard',
    name: "Dragon's Hoard",
    blurb: 'Wake the dragon and raid its treasure.',
    accent: '#ff5470,#ffd15c',
    bg: '#160606,#0b0e16',
    tag: 'HOT',
    stickyWilds: true,
    symbols: [
      { icon: '🥚', weight: 24, pay: 3, name: 'Egg' },
      { icon: '🛡️', weight: 21, pay: 4, name: 'Shield' },
      { icon: '⚔️', weight: 18, pay: 6, name: 'Blade' },
      { icon: '🔥', weight: 13, pay: 10, name: 'Flame' },
      { icon: '🏰', weight: 9, pay: 18, name: 'Keep' },
      { icon: '💰', weight: 7, pay: 33, name: 'Hoard' },
      { icon: '💎', weight: 4, pay: 90, name: 'Gem' },
      { icon: '🐲', weight: 2, pay: 320, name: 'Dragon' },
    ],
  },
  {
    slug: 'mystic-fortune',
    name: 'Mystic Fortune',
    blurb: 'Gaze into the orb for hidden riches.',
    accent: '#b15cff,#23e0c8',
    bg: '#0c0820,#0b0e16',
    expandWilds: true,
    symbols: [
      { icon: '🔮', weight: 24, pay: 3, name: 'Orb' },
      { icon: '🕯️', weight: 21, pay: 4, name: 'Candle' },
      { icon: '🃏', weight: 18, pay: 6, name: 'Tarot' },
      { icon: '🌙', weight: 13, pay: 10, name: 'Moon' },
      { icon: '🦉', weight: 9, pay: 18, name: 'Owl' },
      { icon: '⭐', weight: 7, pay: 33, name: 'Star' },
      { icon: '🧿', weight: 4, pay: 90, name: 'Eye' },
      { icon: '🌌', weight: 2, pay: 300, name: 'Cosmos' },
    ],
  },
  {
    slug: 'tiki-treasure',
    name: 'Tiki Treasure',
    blurb: 'Island spirits guard a golden bounty.',
    accent: '#5cffb1,#ffb15c',
    bg: '#06140a,#0b0e16',
    tag: 'NEW',
    tumble: true,
    symbols: [
      { icon: '🌺', weight: 24, pay: 3, name: 'Hibiscus' },
      { icon: '🥥', weight: 21, pay: 4, name: 'Coconut' },
      { icon: '🍍', weight: 18, pay: 6, name: 'Pineapple' },
      { icon: '🐚', weight: 13, pay: 10, name: 'Shell' },
      { icon: '🪘', weight: 9, pay: 18, name: 'Drum' },
      { icon: '🗿', weight: 7, pay: 33, name: 'Tiki' },
      { icon: '🌴', weight: 4, pay: 90, name: 'Palm' },
      { icon: '🌋', weight: 2, pay: 300, name: 'Volcano' },
    ],
  },
]
